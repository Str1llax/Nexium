package com.str1llax.nexium.worldgen.portal;

import com.str1llax.nexium.blocks.bases.ModPortalBlock;
...
public class NexiumTeleporter implements ITeleporter {
    public static BlockPos thisPos = BlockPos.ZERO;
    public static boolean insideDimension = true;
    private final RegistryObject<Block> teleporterBlock;

    public NexiumTeleporter(BlockPos pos, boolean insideDim, RegistryObject<Block> teleporter) {
        thisPos = pos;
        insideDimension = insideDim;
        teleporterBlock = teleporter;
    }
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, teleporterBlock.get().defaultBlockState(), 3);
            }
        }
