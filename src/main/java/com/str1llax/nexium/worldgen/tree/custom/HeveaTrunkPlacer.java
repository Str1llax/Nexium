...
public class HeveaTrunkPlacer extends TrunkPlacer {
    public static final Codec<HeveaTrunkPlacer> CODEC = RecordCodecBuilder.create(heveaTrunkPlacerInstance ->
            trunkPlacerParts(heveaTrunkPlacerInstance).apply(heveaTrunkPlacerInstance, HeveaTrunkPlacer::new));

    public HeveaTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return NexiumTrunkPlacerTypes.HEVEA_TRUNK_PLACER.get();
    }
