...
public enum ModArmorMaterials implements ArmorMaterial {
    AMETHYST("amethyst", 26, new int[]{3, 7, 5, 3}, 30,
            SoundEvents.AMETHYST_BLOCK_CHIME, 1.5f, 0.0f, () -> Ingredient.of(NexiumItems.AMETHYST.get()));
    ...
    public String getName() {
        return Nexium.MOD_ID + ":" + this.name;
    }
